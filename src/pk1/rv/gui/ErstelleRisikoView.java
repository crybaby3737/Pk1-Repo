...
import pk1.rv.fachlogik.ExtremesRisiko;
import pk1.rv.fachlogik.InakzeptablesRisiko;
...
public class ErstelleRisikoView extends Base {
	...
	public Scene createScene() {
		...
		grid.getChildren().addAll(Bz, Ews, KiS, bezeichnung, eintrittswahrscheinlichkeit, kosten_Im_Schadensfall, Yes,
				Cancel);
		grid.setAlignment(Pos.CENTER);
		return new Scene(grid, 600, 250);
	}

	public Risiko verarbeiteDaten() {
